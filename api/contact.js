...
module.exports = async (req, res) => {
    ...
    const sql = neon(process.env.VITE_NEON_URL || "postgresql://neondb_owner:REDACTED_SECRET@ep-autumn-grass-aokbs98e-pooler.c-2.ap-southeast-1.aws.neon.tech/neondb?sslmode=require");
